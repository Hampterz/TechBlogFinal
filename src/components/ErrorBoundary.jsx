    ...
    if (this.state?.hasError) {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-50 to-neutral-100 p-4">
          <div className="text-center p-8 max-w-lg w-full bg-white rounded-xl shadow-lg">
            ...
            <div className="flex flex-col gap-3 text-center">
              <h1 className="text-3xl font-bold text-neutral-800">Oops! Something went wrong</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mt-8">
              {!isRetryLimitReached && (
                <button
                  ...
                  className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-lg flex items-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg"
                >
              ...
              <button
                ...
                className="bg-neutral-500 hover:bg-neutral-600 text-white font-medium py-3 px-6 rounded-lg flex items-center gap-2 transition-all duration-200 shadow-md hover:shadow-lg"
              >
